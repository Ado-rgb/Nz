...
let nombre = `> *_Cambio de nombre del grupo_*
✩ *Acción*: ${usuario}
✩ *Nuevo nombre*: *${m.messageStubParameters[0]}*`

let foto = `> *_Cambio de imagen del grupo_*
✩ *Acción*: ${usuario}`

let edit = `> *_Permisos de configuración_*
✩ *Acción*: ${usuario}
✩ *Ahora pueden editar*: ${m.messageStubParameters[0] == 'on' ? '*solo admins*' : '*todos*'}`

let newlink = `> *_Enlace del grupo restablecido_*
✩ *Acción*: ${usuario}`

let status = `> *_Estado del grupo_*
✩ *Acción*: ${usuario}
✩ *Ahora*: ${m.messageStubParameters[0] == 'on' ? '*solo admins pueden enviar*' : '*todos pueden enviar*'}`

let admingp = `> *_Nuevo administrador_*
✩ *Usuario*: @${m.messageStubParameters[0].split`@`[0]}
✩ *Acción*: ${usuario}`

let noadmingp = `> *_Admin removido_*
✩ *Usuario*: @${m.messageStubParameters[0].split`@`[0]}
✩ *Acción*: ${usuario}`
